      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-7 mt-7">
        <ol class="relative border-l  border-gray-700 ml-9 mb-6">
          <li class="mb-10" data-aos="zoom-in">
            ...
            <h3 class="flex items-center mb-1 text-lg font-semibold  text-white ml-28">
              Certificado del Inge SANG
            </h3>
            <time class="block pt-1 pb-3  text-sm font-normal leading-none  text-gray-500">
              Finalizado on Febrero 17, 2024
            </time>
            <p class="mb-4 text-base font-normal  text-gray-400">
             Aprendi sobre las tecnologia 4.0 y sus avances para un futuro con robots y maquinas inteligentes.
            </p>
            <a
              href="https://www.udemy.com/certificate/UC-caa0fa20-ac15-4b08-96a9-2ba648e1b2d0/"
              target="_blank"
              rel="noreferrer"
        ...
        <div className="flex flex-col text-center" data-aos="slide-up">
          ...
          <div className="ml-16 flex flex-col gap-8 mt-6">
            <BarGraph name={"JavaScript"} percent={20} />
            <BarGraph name={"React"} percent={50} />
            <BarGraph name={"TypeScript"} percent={10} />
            <BarGraph name={"Java"} percent={10} />
            <BarGraph name={"HTML/CSS"} percent={100} />
